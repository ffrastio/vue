        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('product.update', $items->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="is_loan" class="form-control-label">Dapat Dipinjamkan ?</label>
                        <select name="is_loan" class="form-select form-control">
                            <option value="1" selected>Tidak bisa</option>
                            <option value="0">Bisa</option>
                        </select>
                        @error('is_loan')
                            <div class="text-muted">{{ $message }}</div>
                        @enderror
